    ...
    return (
        ...
        className="bg-gray-400 
            ...
            <div className='grid align-left py-4 lg:grid-cols-2'>         
                <div className='grid gap-6'>
                    ...
                    <form className='grid gap-6'>
                        ...
                        <div className='grid gap-2'>
                            ...
                            <input id='transaction-value' className="peer block w-[184px] h-[48px] cursor-pointer rounded-md border border-primary-400 py-2 pl-2 text-p outline-2" placeholder='0,00'/>
                        </div>
                ...
                <img src='/PersonWithCard.png' alt='Desenho de pessoa segurando cartão gigante' width={327} height={231} className='col-start-2'/>
            </div>
        </div>
    )
}